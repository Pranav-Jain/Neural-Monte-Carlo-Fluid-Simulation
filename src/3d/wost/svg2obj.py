...
if __name__ == '__main__':
    ...
    parser.add_argument('--normalize', action='store_true', help='Normalize vertex positions', default=False)
    parser.add_argument('--use_ccw', action='store_true', help='Use counter-clockwise orientation instead of clockwise')
    parser.add_argument('--auto_orient_curves', action='store_true', help='Orient curves so that they are coherent. Only for non-overlapping, closed curves.', default=True)
